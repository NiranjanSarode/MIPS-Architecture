...
struct MIPS_Architecture
{
	...
	int commandsize = 0;
	int para1[5]={-1,-1,-1,-1,-1};
	int para2[5]={-1,-1,-1,-1,-1};
	int para3[5]={-1,-1,-1,-1,-1};
	int jump_stall = 0;
		...
		if(command[r][0] == "add" || command[r][0] == "sub" || command[r][0] == "mul" || command[r][0] == "slt"){
			...
			if(temp1[(r+4)%5] != -1){
				if(command[(r+4)%5][0] == "lw"){
					if(temp2[r] == temp1[(r+4)%5] || temp3[r] == temp1[(r+4)%5]){add_stall = 1;}
				}
				if(command[(r+4)%5][0] == "beq" || command[(r+4)%5][0] == "bne"){
					add_stall = 0;
				}
			}
		}
			...
			if(temp1[(r+4)%5]!=-1){
				if(command[r][0] == "lw"){
					if(command[(r+4)%5][0] == "lw"){
						...
						if(temp2[r] == temp2[(r+4)%5] && temp3[r] == temp3[(r+4)%5]){
						}
					}
				...
				else if(command[r][0] == "sw"){
					if(command[(r+4)%5][0] == "beq" || command[(r+4)%5][0] == "bne"){
						load_stall = 0;
					}
					else if(command[(r+4)%5][0] == "lw"){
						if(temp2[r] == temp1[(r+4)%5] && temp1[r] == temp1[(r+4)%5]){
							load_stall = 1;
						}
					}
				}
	...
	void exexecute(int r){
		if(command[r][0] == "add"){
			para2[r] = registers[temp2[r]];
			para3[r] = registers[temp3[r]];
			if(temp1[(r+3)%5]!=-1){
				if(command[(r+3)%5][0] == "lw"){
					if(temp2[r] == temp1[(r+3)%5]) para2[r] = temp[(r+3)%5];
					else if(temp3[r] == temp1[(r+3)%5])para3[r] = temp[(r+3)%5];
				}
				else if(command[(r+3)%5][0] == "sw"){}
				else if(temp2[r] == temp1[(r+3)%5]) para2[r] = temp[(r+3)%5];
				else if(temp3[r] == temp1[(r+3)%5]) para3[r] = temp[(r+3)%5];
			}
			if(temp1[(r+4)%5]!=-1){
				if(command[(r+4)%5][0] == "lw"){
					if(temp2[r] == temp1[(r+4)%5]) para2[r] = temp[(r+4)%5];
					else if(temp3[r] == temp1[(r+4)%5]) para3[r] = temp[(r+4)%5];
				}
				else if(command[(r+4)%5][0] == "sw"){}
				else if(temp2[r] == temp1[(r+4)%5]) para2[r] = temp[(r+4)%5];
				else if(temp3[r] == temp1[(r+4)%5]) para3[r] = temp[(r+4)%5];
			}
			temp[r] = para2[r] + para3[r];
		}
		else if(command[r][0] == "addi"){
			para2[r] = registers[temp2[r]];
			if(temp1[(r+3)%5]!=-1){
			...
			int address = para2[r] + temp3[r];
				temp[r] = address / 4;
		}
		else if(command[r][0] == "sw"){
			para2[r] = registers[temp2[r]];
			para1[r] = registers[temp1[r]];

			if(temp1[(r+3)%5]!=-1){
				if(command[(r+3)%5][0] == "lw"){
					if(temp2[r] == temp1[(r+3)%5]) para2[r] =temp[(r+3)%5];
					else if(temp1[r] == temp1[(r+3)%5])para1[r] =temp[(r+3)%5];
				}
				else if(command[(r+3)%5][0] == "sw"){}
				else if(command[(r+3)%5][0] == "beq" || command[(r+3)%5][0] == "bne"){}
				else if(temp2[r] == temp1[(r+3)%5]) para2[r] = temp[(r+3)%5];
				else if(temp1[r] == temp1[(r+3)%5]) para1[r] = temp[(r+3)%5];
			}
			if(temp1[(r+4)%5]!=-1){
				if(command[(r+4)%5][0] == "lw"){
					if(temp2[r] == temp1[(r+4)%5]) para2[r] =temp[(r+4)%5];
					else if(temp1[r] == temp1[(r+4)%5])para1[r]=temp[(r+4)%5];
				}
				else if(command[(r+4)%5][0] == "sw"){}
				else if(command[(r+4)%5][0] == "beq" || command[(r+4)%5][0] == "bne"){}
				else if(temp2[r] == temp1[(r+4)%5]) para2[r] = temp[(r+4)%5];
			...
			if(temp1[(r+3)%5]!=-1){
				if(command[(r+3)%5][0] == "lw"){
					if(temp1[r] == temp1[(r+3)%5]) para1[r] = temp[(r+3)%5];
					else if(temp2[r] == temp1[(r+3)%5])para2[r] = temp[(r+3)%5];
				}
				else if(command[(r+3)%5][0] == "sw"){}
				else if(temp1[r] == temp1[(r+3)%5]) para1[r] = temp[(r+3)%5];
			...
			if(temp1[(r+4)%5]!=-1){
				if(command[(r+4)%5][0] == "lw"){
					if(temp1[r] == temp1[(r+4)%5]) para1[r] = temp[(r+4)%5];
					else if(temp2[r] == temp1[(r+4)%5]) para2[r] = temp[(r+4)%5];
				}
				else if(command[(r+4)%5][0] == "sw"){}
				else if(temp1[r] == temp1[(r+4)%5]) para1[r] = temp[(r+4)%5];
